...
test.group("auth/login", () => {
  ...
  test("error when the user exists but the password is incorrect", async ({
    client,
  }) => {
    const account = await AccountFactory.create();
  ...
  test("error when the user exists, but for a different account", async ({
    client,
  }) => {
  ...
  test("success when the user exists for the given account", async ({
    client,
    expect,
  }) => {
    const account = await AccountFactory.create();
